...
// RISPOSTA: Nel console.log risulterà 2 volte PI essendo che la prima parte (abbastanza ovvia) da il valore e lo riproduce nella console,
...
// RISPOSTA: La variante "var" soddisfa "if" essendo "true", perciò nella console verra registrato prima il messaggio letterale tra virgolette e poi l'elemento favColour (ovvero violet);
...
// RISPOSTA: Il primo console.log si trova all'interno di una funzione, il primo elemento che richiama il console.log è "theSecond" che ritroviamo dentro la funzione, dopo aggiunge la ", " e aggiungere dopo esso
